...
my ($card1, $card2);
$card1 = Games::Cards::Pair::Card->new({ suit => 'clubs', value => 3});
$card2 = Games::Cards::Pair::Card->new({ suit => 'clubs', value => 2 });
is($card1->equal($card2), 0);

$card1 = Games::Cards::Pair::Card->new({ suit => 'clubs', value => 5 });
$card2 = Games::Cards::Pair::Card->new({ suit => 'clubs', value => 5 });
